...
const pageTitle = "Fractional Engineering — THIRD INDEX";
const pageDescription =
  "Fractional software engineering for product teams needing senior frontend judgment, systems work, and production momentum.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 600,
        alt: "Fractional software engineering by THIRD INDEX",
      },
    ],
  },
  twitter: {
