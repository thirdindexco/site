...
export function WorkInquiryCTA() {
  ...
  return (
    <section className="pt-16 md:pt-24 lg:pt-32">
      <div className="mx-auto grid w-full max-w-grid grid-cols-12 gap-4">
        <div className="col-span-12 md:col-span-4 md:col-start-2">
          ...
          <p className="pt-8 font-sans text-sm leading-relaxed md:text-base">
          ...
          <div className="flex flex-col items-start gap-3 pt-8">
            ...
            <a
              ...
              className="font-mono text-3xs font-medium uppercase tracking-tight opacity-65 outline-none transition-opacity hover:opacity-100"
            >
        ...
        <div className="col-span-12 pt-12 md:col-span-4 md:col-start-8 md:pt-0">
          ...
          <ul className="grid pt-6">
            {services.map((service) => (
              <li
                key={service.title}
                className="-mx-3 px-3 transition-colors has-[[data-panel-open]]:bg-foreground/[0.04]"
              >
                <Collapsible.Root>
                  <Collapsible.Trigger className="group/service flex w-full cursor-pointer items-baseline justify-between gap-5 py-3 text-left opacity-55 outline-none transition-opacity duration-200 hover:opacity-100 data-[panel-open]:opacity-100">
                  ...
                  <Collapsible.Panel className="collapsible-panel">
                    <p className="pb-4 pr-1 font-sans text-sm leading-relaxed text-foreground/60">
                      {service.description}
                    </p>
                  </Collapsible.Panel>
                </Collapsible.Root>
